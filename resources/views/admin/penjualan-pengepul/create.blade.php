...
@section('title','Catat Penjualan ke Pengepul')
@section('page-title','Catat Penjualan ke Pengepul')
...
<div class="row g-4">
  ...
  <div class="col-lg-5">
    <div class="table-card">
      <div class="card-header">
        <h6><i class="bi bi-cash-coin me-2" style="color:#16a34a"></i>Form Penjualan ke Pengepul</h6>
      </div>
      <div style="padding:24px">
        <form method="POST" action="{{ route('admin.penjualan-pengepul.store') }}" id="formJual">
          @csrf
          ...
          <div class="mb-4">
            ...
            <input type="date" name="tanggal_jual" id="tanggal_jual"
                   ...
                   value="{{ old('tanggal_jual', $tanggal) }}"
          ...
          <div class="mb-4">
            ...
            <div id="previewNominal" style="font-size:12px;color:#16a34a;margin-top:6px;font-weight:600;min-height:18px"></div>
          </div>
          ...
          <div class="mb-4">
            ...
            <textarea name="catatan" rows="3"
                      ...
                      style="border-radius:8px;font-size:13px;resize:none">{{ old('catatan') }}</textarea>
            @error('catatan')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="mb-4 p-3" style="background:#f8fafc;border-radius:8px;border:1px solid #e2e8f0">
            <div style="font-size:11px;color:#94a3b8;margin-bottom:4px">Admin yang menginput</div>
            <div style="font-size:13px;font-weight:600;color:#374151">
              <i class="bi bi-person-circle me-1"></i>{{ auth()->user()->name }}
            </div>
            <div style="font-size:11px;color:#94a3b8;margin-top:2px">Otomatis terisi setelah submit</div>
          </div>

          {{-- Actions --}}
          <div class="d-flex gap-2">
            <button type="submit" class="btn flex-fill"
                    style="background:#16a34a;color:#fff;border-radius:8px;font-size:13px;font-weight:600;padding:10px">
              <i class="bi bi-check-lg me-1"></i>Simpan Penjualan
            </button>
  ...
  {{-- ── Kolom Kanan: Ringkasan Setoran Hari Itu ── --}}
  <div class="col-lg-7">
    <div class="table-card" id="ringkasanCard">
      <div class="card-header">
      ...
      <div style="padding:20px" id="ringkasanBody">
        @if($ringkasan->jumlah_nasabah > 0)
          ...
          <div class="mt-3 p-3" style="background:#fefce8;border-radius:8px;border:1px solid #fde68a">
            ...
            <span style="font-size:12px;color:#92400e">
              Nilai di atas adalah <strong>harga internal</strong> yang dikreditkan ke nasabah.
              Harga jual ke pengepul bisa berbeda — masukkan nominal yang disepakati dengan pengepul.
            </span>
          </div>
        @else
          <div class="text-center py-5" style="color:#94a3b8">
            ...
            <div style="font-size:12px;margin-top:4px">Ubah tanggal pada form untuk melihat ringkasan.</div>
          </div>
        @endif
      </div>
    </div>
...
@push('scripts')
<script>
// Preview nominal terbilang saat user mengetik
